					...
					<article className={career.company}>
						<div className={career.companyContent}>
							<span className={career.companyHeader}>
								<h3>Taasa Analytics.</h3>
								<h4>Permanent Full-time</h4>
								<h4>Apr 2022 - Present · 1 yrs 10 mos</h4>
								<h5>Kampala, Uganda</h5>
							</span>
							<p>
							Taasa Analytics. helps Ugandans get access to emergency medical services comfortably. manage mental and physical health with naturally occurring nootropic and adaptogenic products. They carry products with complex attributes, aiming to solve a large variety of personal care needs — this requires an extremely customized and evolving approach to how the store is built and functions.
							</p>
						</div>
